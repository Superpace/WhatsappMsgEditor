...
ISIM = "Batuhan" #Sohbet ismini seÃ§tik
whatsappTxt = open("deneme1.txt","r+",encoding="utf8") 
cumleler = list()
kelimeler = list()
# AynÄ± klasÃ¶rde olan dosyamÄ±zÄ± hem okuma hem de yazma olanaÄŸÄ± sunan
# W+ modunda aÃ§Ä±yoruz
veri=whatsappTxt.read()
satirlar=veri.split("\n") #veri deÄŸiÅŸkenindeki \n lere gÃ¶re parÃ§alayÄ±p
                         #veriler deÄŸiÅŸkenine atar ve veriler deÄŸiÅŸkeni
                         #artÄ±k dizi olur
